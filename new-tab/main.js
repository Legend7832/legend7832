...
import { BackgroundUpdater } from "./backgroundUpdater.js"; // Update the import statement
...
webStore.addEventListener('click', () => {
    ...
    if (version < 113) { // not sure if this is actually the version
        alert("This web store may not be supported by your version");
    }
